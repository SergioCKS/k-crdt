...
export function __wbg_get_packedboolregister_id(a: number): number;
export function __wbg_set_packedboolregister_id(a: number, b: number): void;
export function __wbg_get_packedboolregister_value(a: number): number;
export function __wbg_set_packedboolregister_value(a: number, b: number): void;
export function packedboolregister_new(a: number, b: number, c: number, d: number): number;
export function packedboolregister_getEncoded(a: number, b: number): void;
export function packedboolregister_getUpdateMessage(a: number, b: number, c: number, d: number): void;
